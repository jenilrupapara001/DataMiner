    ...
    try {
        ...
        await pool.request()
            ...
            .query(`
                ...
                VALUES (@Id, @Type, @SellerId, 1, dbo.GetEnvDate(), dbo.GetEnvDate())
            `);
        ...
        await pool.request()
            ...
            .query(`
                ...
                BEGIN
                    ...
                    VALUES (@msgId, @userId, @emoji, dbo.GetEnvDate())
                END
            `);
        ...
        await pool.request()
            ...
            .query(`
                ...
                BEGIN
                    ...
                    SET IsRead = 1, ReadAt = dbo.GetEnvDate()
                    WHERE MessageId = @msgId AND UserId = @userId
                END
            `);
...
exports.acceptCall = async (req, res) => {
    try {
        ...
        await pool.request()
            ...
            .query(`
                UPDATE CallLogs
                SET Status = 'ONGOING', StartedAt = dbo.GetEnvDate()
...
exports.endCall = async (req, res) => {
    try {
        ...
        await pool.request()
            ...
            .query(`
                UPDATE CallLogs
                SET Status = 'ENDED', EndedAt = dbo.GetEnvDate(), Duration = @duration
                WHERE Id = @callId
            `);
...
exports.createGroup = async (req, res) => {
    try {
        ...
        await pool.request()
            ...
            .input('SellerId', sql.VarChar, sellerId || null)
            .query("INSERT INTO Conversations (Id, Type, Title, SellerId, IsActive, CreatedAt, UpdatedAt) VALUES (@Id, @Type, @Title, @SellerId, 1, dbo.GetEnvDate(), dbo.GetEnvDate())");
