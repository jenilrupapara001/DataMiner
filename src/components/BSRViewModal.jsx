    ...
    <div className={`position-fixed top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center ${isFullscreen ? 'p-0' : 'p-3'}`}
      ...
      <div className={`bg-white shadow-2xl d-flex flex-column ${isFullscreen ? 'w-100 h-100 rounded-0' : 'rounded-3'}`}
        ...
        <div className="px-4 py-2 bg-white border-bottom d-flex align-items-center gap-3 flex-shrink-0 flex-wrap">
          ...
          {(filterStatus !== 'all' || localSearch || currentSellerId) && (
            <button className="chp text-red-500 border-red-100 bg-red-50" onClick={() => { resetAllFilters(); setCurrentSellerId(''); }} style={{ fontSize: '10px' }}>
          ...
          <table className="bt">
            <thead>
              <tr>
                ...
                <th style={{ minWidth: '80px', position: 'sticky', left: '85px', zIndex: 30, background: '#fff' }} onClick={() => handleSort('asinCode')}>
                  <div className="d-flex align-items-center gap-2">ASIN <Si f="asinCode" /></div>
                </th>
                <th style={{ width: '120px' }}>SKU</th>
                <th style={{ width: '160px', textAlign: 'right' }} onClick={() => handleSort('mainBsr')}>
                ...
                <th style={{ width: '85px', textAlign: 'center', background: '#f0fdf4' }} onClick={() => handleSort('wowPercent')}>
