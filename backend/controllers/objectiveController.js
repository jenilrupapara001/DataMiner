    ...
    try {
        ...
        await pool.request()
            ...
            .query(`
                ...
                VALUES (@Id, @Title, @Description, @StartDate, @EndDate, @SellerId, @CreatedBy, dbo.GetEnvDate(), dbo.GetEnvDate())
            `);
            ...
            for (const kr of keyResults) {
                ...
                await pool.request()
                    ...
                    .query(`
                        ...
                        VALUES (@Id, @ObjectiveId, @Title, @Description, @OwnerId, @TargetValue, @Unit, 0, dbo.GetEnvDate(), dbo.GetEnvDate())
                    `);
            }
        }
