    ...
    try {
      ...
      await pool.request()
        ...
        .query(`
          ...
          VALUES (@Id, @Title, @Description, @Type, @Priority, @Status, @CreatedBy, @KeyResultId, @IsAIGenerated, @AiReasoning, @DueDate, dbo.GetEnvDate(), dbo.GetEnvDate())
        `);
      ...
      for (const t of tasks) {
        ...
        await pool.request()
          ...
          .query(`
            ...
            VALUES (@Id, @Title, @Description, @Type, @Priority, @Status, @CreatedBy, @KeyResultId, @IsAIGenerated, @AiReasoning, dbo.GetEnvDate(), dbo.GetEnvDate())
          `);
